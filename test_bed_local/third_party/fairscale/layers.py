...
from test_bed_local.third_party.fairscale.mappings import (
    copy_to_model_parallel_region,
    gather_from_model_parallel_region,
    reduce_from_model_parallel_region,
    scatter_to_model_parallel_region,
)
from test_bed_local.third_party.fairscale.utils import VocabUtility, divide_and_check_no_remainder
