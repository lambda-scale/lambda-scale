...
from test_bed_local.third_party.fairscale.model_parallel.initialize import get_model_parallel_rank, get_model_parallel_world_size
from test_bed_local.third_party.fairscale.model_parallel.mappings import (
    copy_to_model_parallel_region,
    gather_from_model_parallel_region,
    reduce_from_model_parallel_region,
    scatter_to_model_parallel_region,
)
from test_bed_local.third_party.fairscale.model_parallel.utils import VocabUtility, divide_and_check_no_remainder
