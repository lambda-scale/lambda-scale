...
from test_bed_local.third_party.fairscale.model_parallel.utils import ensure_divisibility
...
def init_tp(tp_size_,
            self_rank_,
            tp_group_ranks_):
    global tp
    global tp_size
    global self_rank
    global tp_group_ranks
    global tp_group
    tp = True
    tp_size = tp_size_
    self_rank = self_rank_
    tp_group_ranks = tp_group_ranks_
    tp_group = torch.distributed.new_group(tp_group_ranks, backend='nccl')
