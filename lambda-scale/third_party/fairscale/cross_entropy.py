...
from test_bed_local.third_party.fairscale.initialize import get_model_parallel_group, get_model_parallel_rank, get_model_parallel_world_size
from test_bed_local.third_party.fairscale.utils import VocabUtility
